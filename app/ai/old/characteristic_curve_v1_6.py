...
def _operational_decision(
    ...
    if fallback_ratio > cfg.max_fallback_ratio:
        blockers.append("fallback_heavy_sample")
    if trading_confidence < cfg.medium_decision_confidence:
        blockers.append("low_trading_confidence")
...
def analyze(
    ...
    if explicit_benchmark:
        ...
        try:
            from app.ai.benchmark_resolver_v1_3 import BENCHMARK_ROLE
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Characteristic Curve Engine V1.6"
    )
