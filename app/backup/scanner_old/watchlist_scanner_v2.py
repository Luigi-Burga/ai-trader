"""AI Trader - Watchlist Scanner V2.0
...
from app.ai.decision_gate_v1_2 import apply_decision_gate
...
def _gate_input(
    ...
    # The Orchestrator exposes the authoritative resolver result as
    # `orchestrator_benchmark_resolution`. Do not use the CCE-internal
    # `benchmark_resolution` when the Orchestrator result is available,
    # because CCE sees the already-resolved benchmark as a manual override.
    orchestrator_resolution = analysis.get("orchestrator_benchmark_resolution")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="AI Trader Watchlist Scanner V2.0"
    )
