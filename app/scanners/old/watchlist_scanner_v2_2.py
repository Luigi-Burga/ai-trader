...
Production pipeline:
    watchlist -> Orchestrator V1.5.1 -> Decision Gate V1.3 -> Signal Engine V1.2

Decision Gate V1.3 uses CCE V1.7 APPT_X_20D together with the
...
from app.strategies.decision_gate_v1_3 import apply_decision_gate
