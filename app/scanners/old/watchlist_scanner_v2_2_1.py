"""AI Trader - Watchlist Scanner V2.2

Production pipeline:
    watchlist -> Orchestrator V1.5.1 -> Decision Gate V1.4 -> Signal Engine V1.2

Decision Gate V1.4 uses CCE V1.7 APPT_X_20D together with the
Orchestrator-provided dynamic entry/stop structure. buy_target remains
informational only and is never a BUY trigger.
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="AI Trader Watchlist Scanner V2.2"
    )
